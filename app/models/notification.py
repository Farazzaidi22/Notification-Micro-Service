...
class NotificationModel(Base):
    ...
    org_id = Column(Integer, nullable=False, comment="Organization ID")
    
    condition = Column(String, default=None, comment="Additional condition for the notification")
    
    sender = Column(String, index=True, comment="Name of service sending the notification")
    ...
    trigger_at = Column(TIMESTAMP, default=func.now(), comment="Timestamp indicating when the notification should be triggered")
